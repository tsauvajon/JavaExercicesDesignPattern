 ...
 * @author Thomas Kint
 */
public class PizzaKebab extends IPizza {

    public PizzaKebab(IFabriqueIngredient fabriqueIngredient) {
        ...
        viande = (Viande) this.fabriqueIngredient.fabriqueViande("kebab");
    }
}
